...
def loadCam(args, id, cam_info, resolution_scale, flow_dirs):
    ...
    if cam_info.thinned is None:
        thinned = None
    else:
        thinned = cam_info.thinned/args.resolution    
    
    semantic_seg = None 
    if cam_info.semantic_seg is not None:
        semantic_seg = cv2.resize(cam_info.semantic_seg, resolution)             
    ...
    return Camera(colmap_id=cam_info.uid, R=cam_info.R, T=cam_info.T,
                  ...
                  depth=cam_info.depth, thinned=thinned, semantic_seg=semantic_seg, flow_dirs=flow_dirs, K=cam_info.K, reference_points=cam_info.reference_points)
