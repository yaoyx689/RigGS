...
class ModelParams(ParamGroup):
    def __init__(self, parser, sentinel=False):
        ...
        self._data_type = "" # choices=["Colmap", "Blender", "DTU", "nerfies", "plenopticVideo", "CMU", "ZJU"])
        self._images = "images"
        self._resolution = -1
        ...
        self.use_isotropic_gs = False 
        
        # for skeleton-based deformation 
        self.use_skinning_weight_mlp = False 
        self.use_template_offsets = False 
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        # for skeleton-based deformation 
        self.skeleton_weight_knn = -1
        self.skeleton_warm_up = 1_000
        self.gs_densification_iterations = 5000
        self.deform_mlp_lr_init = 1e-4
        self.deform_mlp_lr_final = 1e-5
        self.deform_mlp_lr_delay_mult = 0.01
        self.deform_mlp_lr_max_steps = 60_000
        
        self.skeleton_gs_position_lr = 0.0000016
        self.num_gs_sample = 0 
        
        # loss weights:
        # self.lambda_node_trans = 0
        # self.lambda_skinning_weight_offsets = 0
        self.lambda_template_offsets = 1.0
        
        self.lambda_rendering_image = 1
        self.lambda_template_fixed = 100
        self.lambda_deformed_node_prjection = 1e-3

        self.optimize_template_offsets_iters = 15000
        self.manually_key_frame = -1
